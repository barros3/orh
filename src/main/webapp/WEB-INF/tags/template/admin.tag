				...
				<ul class="nav navbar-nav">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">Colaborador <span class="caret"></span></a>						
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
							...
							<a tabindex="0" href="#" class="dropdown-toggle" data-toggle="dropdown">Férias<span class="caret"></span></a>
								<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Férias <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="<c:url value='/ferias/novo-ferias' />">Novo</a></li>
							<li><a href="<c:url value='/ferias/list' />">Pesquisar</a></li>
							<li><a href="<c:url value='/ferias/list-visu' />">Visualizar</a></li>
